...
def show_home_page():
    st.subheader("Get Started with AutoGraph")
    st.write("AutoGraph is your gateway to data analysis and preprocessing. We've simplified the process to help you make the most of your data.")
    ...
    st.write('<style>'
            ...
            '.audience {flex: 0 1 calc(50% - 10px); background-color: #262730; border-radius: 10px; margin: 5px; padding: 10px; text-align: center;}'
